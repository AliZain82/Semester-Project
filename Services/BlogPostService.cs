...
using Blogging_web.Models;
using Microsoft.EntityFrameworkCore;

namespace Blogging_web.Services
{
    public class BlogPostService
    {
        ...
        public async Task<IEnumerable<Post>> GetPostsAsync(bool publishedOnly = false, string? categorySlug = null)
        {
        ...
        public async Task<MethodResult> SaveAsync(BlogSaveModel post, int userId)
        {
            ...
            else
            {
                ...
                Post? entity = await _context.BlogPosts
